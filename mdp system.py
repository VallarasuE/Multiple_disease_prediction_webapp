...
diabetes_model = pickle.load(open('H:/Project/Multiple Disease Prediction System/Saved Models/diabetes_model.sav' , 'rb'))

heartdisease_model = pickle.load(open('H:/Project/Multiple Disease Prediction System/Saved Models/heartdisease_model.sav' , 'rb'))

parkinsonsdisease_model = pickle.load(open('H:/Project/Multiple Disease Prediction System/Saved Models/parkinsonsdisease_model.sav' , 'rb'))

kidneydisease_model = pickle.load(open('H:/Project/Multiple Disease Prediction System/Saved Models/kidneydisease_model.sav' , 'rb'))
...
if (selected == "Parkinsons Disease Prediction"):
    ...
    if st.button("Parkinson's Test Result"):
        parkinsons_prediction = parkinsonsdisease_model.predict([[fo, fhi, flo, Jitter_percent, Jitter_Abs, RAP, PPQ,DDP,Shimmer,Shimmer_dB,APQ3,APQ5,APQ,DDA,NHR,HNR,RPDE,DFA,spread1,spread2,D2,PPE]])                          
